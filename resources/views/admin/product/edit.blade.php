...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">Ürün Düzenle</span>
        </h4>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="long_description" rows="1" id="longDescription">{!! $product->long_description !!}</textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="price" id="productPrice" value="{{ $product->price }}" class="form-control form-control-sm" placeholder="100" aria-label="Tutar">
                                </div>
                            </div>
                            <!-- OfferPrice -->
                            <div class="mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="show_at_home" id="select" class="form-select form-select-sm">
                                    <option @selected($product->show_at_home === 1) value="1">Aktif</option>
                                    <option @selected($product->show_at_home === 0) value="0">Pasif</option>
                                </select>
                            </div>
                            <!-- Status -->
                            <div class="mb-3">
                                ...
                                <select name="status" id="select" class="form-select form-select-sm">
                                    <option @selected($product->status === 1) value="1">Aktif</option>
                                    <option @selected($product->status === 0) value="0">Pasif</option>
                                </select>
                            </div>
                        ...
                        <div class="card-body ">
                            ...
                            <div class="product-image-center">
                                <img src="{{ $product->thumb_image }}"
                                     alt="user-avatar" class="d-block sw-px-100 sh-px-100 mb-3 rounded" id="uploadedAvatar" />
                            </div>
