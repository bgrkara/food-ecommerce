...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">Kupon Ekle</span>
        </h4>
        <!-- Datatable -->
        <div class="row">
            <!-- Media -->
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="quantity" id="couponQuantity" class="form-control" value="{{ old('quantity') }}" placeholder="50" aria-label="Miktar">
                                </div>
                            </div>
                            <div class="col-md-6 col-12 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="min_purchase_amount" id="minPurchasePrice" class="form-control" value="{{ old('min_purchase_amount') }}" placeholder="50" aria-label="Tutar">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-12 mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">(%) / ({{ config('settings.site_currency_icon') }})</span>
                                    <input type="number" name="discount" id="couponDiscount" class="form-control" value="{{ old('discount') }}" placeholder="50" aria-label="Tutar">
                                </div>
                            </div>
{{--                            <div class="col-md-6 col-12 mb-3">--}}
{{--                                <label for="expireDate" class="form-label">Sona Erme Tarihi</label>--}}
{{--                                <input type="text" id="expireDate" name="expire_date" class="form-control" value="{{ old('expire_date') }}" placeholder="AA/GG/YYYY"/>--}}
{{--                            </div>--}}
                            <div class="col-md-6 col-12 mb-4">
                                <label for="expireDate" class="form-label">Sona Erme Tarihi</label>
                                <input type="text" class="form-control flatpickr-input" name="expire_date" placeholder="GG-AA-YYYY" id="expireDate" value="{{ old('expire_date') }}" readonly="readonly">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-12 mb-3">
                                ...
                                <select name="discount_type" id="discountType" class="form-select">
                                    ...
                                    <option value="amount">Tutar İndirimi ({{ config('settings.site_currency_icon') }})</option>
                                </select>
                            </div>
                            <div class="col-md-6 col-12 mb-3">
