                            ...
                            <ul class="nav nav-tabs card-header-tabs" role="tablist">
                                ...
                                <li class="nav-item">
                                    <button
                                        class="nav-link"
                                        data-bs-toggle="tab"
                                        data-bs-target="#pusher-setting"
                                        role="tab"
                                        aria-selected="false">
                                        <svg width="65" height="20" viewBox="0 0 121 32" fill="none" xmlns="http://www.w3.org/2000/svg" class="db" role="img" aria-labelledby="svg-c4d3f447">
                                            <g>
                                            ...
                                            <title id="svg-c4d3f447">Pusher</title></svg>&nbsp;Ayarları
                                    </button>
                                </li>
                                <li class="nav-item">
                                    <button
