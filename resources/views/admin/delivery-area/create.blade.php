...
@endpush
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">Teslimat Alanı Ekle</span>
        </h4>
        <!-- Datatable -->
        <div class="row">
            <!-- Media -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="delivery_fee" id="deliveryFee" class="form-control" value="{{ old('delivery_fee') }}" placeholder="50" aria-label="Tutar">
                                </div>
                            </div>
                            <div class="col-md-6 col-12 mb-3">
