...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">Slider Düzenle</span>
        </h4>
        <!-- Datatable -->
        <div class="row">
            <!-- Media -->
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="price" id="price_column" class="form-control" placeholder="100" value="{{ intval($slider->price) }}" aria-label="Tutar">
                                </div>
                            </div>
                            <div class="mb-3 col-md-6">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">TL</span>
                                    <input type="number" name="discount_price" id="discount_price_column" class="form-control" placeholder="50" value="{{ intval($slider->discount_price) }}" aria-label="Tutar">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="offer" id="offercolumn" class="form-control" placeholder="30" value="{{ $slider->offer }}" aria-label="Yüzde">
                                </div>
                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="select" class="form-label">Durum</label>
                                <select name="status" id="select" class="form-select">
                                    <option @selected($slider->status === 1) value="1">Aktif</option>
                                    <option @selected($slider->status === 0) value="0">Pasif</option>
                                </select>
                            </div>
                        </div>
                        <div class="mt-2">
