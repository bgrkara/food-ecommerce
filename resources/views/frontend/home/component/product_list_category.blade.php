        ...
        <div class="ps-portfolio__content">
            ...
            <div class="ps-portfolio__tabs">
                <ul class="nav nav-tabs" id="productContentTabs" role="tablist">
                    <li class="nav-item" role="presentation"><a class="nav-link active" id="product-all-tab" data-toggle="tab" href="#product-all-content" role="tab" aria-controls="portfolio-all-content" aria-selected="true">Tüm Ürünler</a></li>
                ...
                <div class="tab-content" id="productContent">
                    <div class="tab-pane fade show active" id="product-all-content" role="tabpanel" aria-labelledby="product-all-tab">
                        <div class="row">
                                                ...
                                                <div class="ps-product__content">
                                                    ...
                                                    <div class="ps-product__desc">
                                                        <ul class="ps-product__list">
                                                            <li>%100 Para İadesi</li>
                                                            <li>Temassız Teslimat</li>
                                                            <li>300₺ ve Üzeri Siparişlerde Ücretsiz Teslimat</li>
                                                        </ul>
                                                    </div>
